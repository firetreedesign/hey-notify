<?php
/**
 * EDD Software Licensing for Hey Notify
 *
 * @package Hey_Notify
 */
 ...
 * @version 1.9.2
 */
class Hey_Notify_EDD_SL_Plugin_Updater {
	...
	public function show_update_notification( $file, $plugin ) {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			...
			printf(
				...
				esc_html( __( '%1$sView version %2$s details%3$s.', 'easy-digital-downloads' ) ),
			...
			printf(
				...
				esc_html( __( '%1$sView version %2$s details%3$s or %4$supdate now%5$s.', 'easy-digital-downloads' ) ),
				'<a target="_blank" class="thickbox open-plugin-details-modal" href="' . esc_url( $changelog_link ) . '">',
				esc_html( $update_cache->response[ $this->name ]->new_version ),
				'</a>',
